...
import DrawerToggler from '../toggler/drawerToggler';
...
function Navbar() {
    ...
    return (
        <div className="relative bg-transparent">
            ...
            {/* Mobile menu */}
            <div className={" fixed top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden bg-transparent z-10".concat(" ", IsDrawerOpen ? "-translate-y-0 " : "-translate-y-full ")}>
